...
NPC1_ROUTE = [
    ...
    Transform(
        Location(13.695746, 18.811819,
                 0.1), Rotation(-0.000031, -43.884972, -0.007568)
    ),
    Transform(
        Location(22.825905, 1.144211, 0.1), Rotation(
            0.003324, -89.318871, -0.000676)
    ),
    Transform(
    ...
    Transform(
        Location(-13.913259, -18.567612,
                 0.1), Rotation(-0.000031, 140.858994, 0.021522)
    ),
    Transform(
        Location(-23.580221, -2.984560,
                 0.1), Rotation(-0.000122, 99.207008, -0.014651)
    ),
    Transform(
        Location(-20.525547, 12.254155,
                 0.1), Rotation(-0.000305, 57.465370, -0.036132)
    ),
]
NPC2_ROUTE = [
    Transform(Location(165.969940, -194.172440, 0.1),
              Rotation(0.0, 1.005202, 0.0)),
    Transform(Location(232.168045, -21.722141, 0.1),
              Rotation(0.0, 92.112457, 0.0)),
]
NPC3_ROUTE = [
    Transform(Location(-16.424643, -135, 0.1), Rotation(0.0, 1.1394, 0.0)),
    Transform(Location(7.562178, -181.43866, 0.1),
              Rotation(0.0, -88.1558, 0.0)),
    Transform(Location(-46.9482, -205.7256, 0.1),
              Rotation(0.0, -177.528, 0.0)),
...
TASK_ENDPOINTS = [
    ...
    ("B", Location(173.494965, -190.685989, 0),
     Location(229.268784, -28.728645, 0)),
    ("C", Location(63.244614, -209.547195, 0),
     Location(-107.195251, 129.096527, 0)),
]
